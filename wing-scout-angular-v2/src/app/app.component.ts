...
hier gehts los. hier müssen wir uns alles raus ziehen was wir für unsere modale brauchen
und das in eine app.modals.ts verfrachten.. aufpassen das wir nichts weg negnehmen was wir
für unser main file hier brauchen, da wir den return für unseren 
header, main und footer in einer hmtl untergebracht haben.
...
export class AppComponent {
  ...
  modals = './app.modals.html'; // Pfad zu den Modalen
  ...
  handleExportToPDF() {
    ...
    doc.setFontSize(14);
    doc.text(
      `Gesamtpreis: ${this.calculateTotalPrice()} Credits`,
      10,
      yPosition + 10
    );
    */
